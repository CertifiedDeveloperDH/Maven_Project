...
public class AppUser implements UserDetails {
    ...
    @Id
    @SequenceGenerator(name = "secuencia_user", sequenceName = "secuencia_user", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "secuencia_user")
    private long id;
    private String name;
